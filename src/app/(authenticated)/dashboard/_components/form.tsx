...
import { ChevronDown, ChevronRight, MapPin, Building2, FileText, Image, Ghost } from "lucide-react"
...
export default function ComplainForm() {
    ...
    const rowsToShow: complaint[] = pathname === '/dashboard' ? complaindata.slice(0, 5) : complaindata;
                    ...
                    <CardContent className="p-0">
                        <div className="overflow-x-auto">
                                ...
                                <TableBody className="w-full">
                                    {
                                        rowsToShow.map((complaint) => (
                                            <React.Fragment key={complaint.id}>
                                                ...
                                                {expandedRow === complaint.id && (
                                                    <TableRow>
                                                        <TableCell colSpan={6} className="bg-slate-50 border-t-0">
                            ...
                            <div className="w-full flex items-center mt-5">
                                {
                                    pathname === '/dashboard' &&
                                    <Link href="/complaints" className="w-full text-center hover:underline">View All</Link>
                                }
                            </div>
                        </div>
                    </CardContent>
